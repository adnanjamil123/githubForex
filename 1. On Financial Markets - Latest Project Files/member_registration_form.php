...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form name="registration"  action="UserRegistration" onsubmit="return formValidation()" method="POST" >
      ...
      <div class="md-form">
        ...
        <input type="text" id="materialFormCardFirstNameEx" class="form-control" name="f_name" onfocusout="f_name_input_keys(this)"  required>
      ...
      <div class="md-form">
        ...
        <input type="text" id="materialFormCardLastNameEx" class="form-control" name="l_name" onfocusout="l_name_input_keys(this)" required>
	...
	<!-- Material input password -->
      <div class="md-form">
        ...
        <input type="text" id="materialFormCardPhoneEx" class="form-control" name="phone_no" onfocusout="phone_no_input_keys(this)" required>
	...
	<!-- Material input password -->
      <div class="md-form">
        ...
        <input type="text" id="materialFormCardDOB" class="form-control" name="date_of_birth" onfocusout="date_of_birth_input_keys(this)" required>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
    ...
    <div class="col-7">
      ...
      <input type="text" class="form-control" placeholder="City" name="city_town" onfocusout="city_town_input_keys(this)" required >
    ...
    <div class="col">
      <!-- Default input -->
      <input type="text" class="form-control" placeholder="Street No" name="street_number" onfocusout="street_number_input_keys(this)" required>
    ...
    <div class="col">
      <!-- Default input -->
      <input type="text" class="form-control" placeholder="Postal/Zip" name="postal_zip_code" onfocusout="postal_zip_code_input_keys(this)"required>
 ...
 <label class="font-weight-light">Account Type</label>
	...
	<input type="range" id="leverage_current_value" value="50" onchange="leverage_value();" class="custom-range" min="50" max="500" step="50" id="customRange3" name="account_leverage" required>
	  ...
	  <div class="form-group">
		<input type="text" class="form-control" id="inputAddress" placeholder="Expected Investment Balance" name="expected_investment_balance" onfocusout="expected_investment_balance_input_keys(this)" required>
