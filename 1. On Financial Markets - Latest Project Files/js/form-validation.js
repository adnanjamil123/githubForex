...
function forgotchangepassowrdformValidation()
{
	var user_password = document.forgotchangepassword_form.user_password;
	var confirm_user_password = document.forgotchangepassword_form.confirm_user_password;
...
{
	var withdraw_amount = document.transaction_form.withdraw_amount;

	if(current_paymentMethod())
	{
		if(transaction_amount_input_keys(withdraw_amount))
		{
			return true;
		}
	}
...
{
	var deposit_amount = document.transaction_form.deposit_amount;
	
	if(current_paymentMethod())
	{
		if(transaction_amount_input_keys(deposit_amount))
		{
			return true;
		}
	}
