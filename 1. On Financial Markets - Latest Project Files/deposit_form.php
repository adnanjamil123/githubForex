...
<div class="card" style="padding:30px;">
  ...
  <div class="card-body">
    ...
    <form name="transaction_form"  action="payment_deposit_processing" onsubmit="return depositformValidation()" method="POST" >
      <p class="h4 text-center py-4">Deposit Information</p>
	  ...
	  <div class="form-group">
		<input type="text" class="form-control" id="inputAddress" placeholder="Enter amount" name="deposit_amount" onfocusout="transaction_amount_input_keys(this)" required>
			<i id="error_transaction_amount" style="float:right; color:red"></i>
	  </div>
	  
	  <div class="text-center py-4 mt-3">
        <button class="btn btn-cyan" name="payment_deposit_btn" type="submit">Deposit</button>
      </div>
