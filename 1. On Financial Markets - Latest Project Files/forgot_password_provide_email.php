...
<div class="card" style="padding:30px; opacity:0.9;">
  ...
  <div class="card-body">
    ...
    <form method="POST" name="login" action="ForgotAuth" onsubmit="return loginformValidation()">
      <p class="h4 text-center py-4">Account Verification</p>
	  ...
	  <div class="text-center py-4 mt-3">
        <button class="btn btn-cyan" type="submit" name="forgot_btn">Submit</button>
      </div>
	  
	   
	  <center> <a href="member_login"> <h6>Back</h6> </a> </center>
