...
$(document).ready(function () {
    ...
    $('.youtube-vid-iframe').attr('src',"");

    $('.youtube-video-overlay').click(function() {
        var videoYoutube = "https://www.youtube.com/embed/5UujIOiEsFQ";
        $('html, body').animate({
            scrollTop: $("#youtube-video-overlay").offset().top-15
        }, 500);
        $(this).hide();
        $('.youtube-vid-iframe').attr('src',videoYoutube+"?controls=0&rel=0&showinfo=0&enablejsapi=1&autoplay=1&modestbranding=1&theme=light");
        $('.youtube-video').show();
    });
    $('.youtube-video-overlay').hover(function(e) {
